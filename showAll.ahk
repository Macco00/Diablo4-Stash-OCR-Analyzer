...
else ; 1920x1080
{
	...
	textHeight := 12 ; text background height
	textWidth := 56 ; text background width
	offsetBack := 4.6 ; text background offset on y axis

	offsetX := 20 ; text offset
	offsetY := 3 ; text offset
...
drawAspects(myGui, stashGrid, offsetX, offsetY, lookingFor, nameAsp, res)
