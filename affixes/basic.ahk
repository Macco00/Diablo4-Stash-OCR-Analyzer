getBasicArray()
{
	;[maxValue, infoText, itemType]
	;maxValue not really needed
	
	; ctrl f "edge case" to find affixes that dont start with number
	; ctrl f "404" for affixes with numbers within the string and not the start
	...
	basicArray := [
		...
		[0.315, "Lucky Hit: Up to a 5% Chance to Heal 404 Life","Totem, Focus, Focus, Gloves, Shield"], ;edge case
		[2, "Reduces the Arm Time of Your Trap Skills by 404 Seconds","Amulet, Gloves"], ;edge case
		; ------percentages--------
		...
		[7, "Golem Inherit 404 of Your Thorns","Pants, Ring"],
		[7, "Mages Inherit 404 of Your Thorns","Helm, Ring"],
		[7, "Warriors Inherit 404 of Your Thorns","Gloves, Ring"],
		[10, "Lucky Hit: Up to a 404 Chance to Execute Injured Non-Elites","Axe, Two-Handed Axe, Bow, Hand Crossbow, Crossbow, Dagger, DaggerOffHand, Mace, Two-Handed Mace, Two-Handed Mace, Polearm, Scythe, Two-Handed Scythe, Staff, Sword, Two-Handed Sword, Wand"],
		[14, "Lucky Hit: Up to a 5% Chance to Restore 404 Primary Resource","Totem, Focus, Focus, Gloves, Shield"],
		[20, "Lucky Hit: Up to a 404 Chance to Slow","Totem, Focus, Focus, Gloves, Shield"],
	]
	return basicArray
}